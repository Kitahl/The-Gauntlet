...
SPEC_FILES = [
    ...
    "docs/specs/GAUNTLET_ENGINEERING_SPEC.md", "docs/specs/MEDITATE_ENGINEERING_SPEC.md",
...
# Skill directories remain specification-only and now trace to engineering specs.
...
# Runtime/control boundary: Mastermind may appear in historical prose elsewhere in the
# full repo, but never in this new runtime/control substrate.
...
# Specific research-hardening invariants.
