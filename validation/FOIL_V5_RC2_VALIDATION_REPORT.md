...
| Check | Result |
|---|---|
| `python -m unittest discover -s tests` | **PASS — 703 tests in 56.843 s** |
| Focused adaptive/ledger/pilot suite | **PASS — 37 tests** |
...
pilot. Whatever it observes remains development evidence forever and cannot
promote or certify RC2.
