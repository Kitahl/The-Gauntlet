...
checks["implementation_directory_exposed"] = len([p for p in (ROOT / "tools").glob("*.py") if p.name != "__init__.py"]) == 67 and "https://github.com/Kitahl/The-Gauntlet/tree/main/tools" in html
