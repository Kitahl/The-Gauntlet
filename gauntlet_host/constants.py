...
TOKEN_MEASUREMENT_PROTOCOL_VERSION = "gauntlet.token-measurement.v1"
TOKEN_MEASUREMENT_SUMMARY_VERSION = "gauntlet.token-measurement-summary.v1"
FINALIZATION_PROTOCOL_VERSION = "gauntlet.finalization.v1"
FOIL_ROUTE_PROTOCOL_VERSION = "gauntlet.foil-route.v1"
LEAN_PREFETCH_PROTOCOL_VERSION = "gauntlet.lean-prefetch.v1"
COMPACT_STATUS_PROTOCOL_VERSION = "gauntlet.compact-status.v1"
MAX_JSONL_BYTES = 1_048_576
MAX_OPERATIONAL_ERROR_CHARS = 2_000
MAX_FOIL_ROUTE_INPUT_BYTES = 131_072
MAX_FOIL_ROUTE_OUTPUT_BYTES = 131_072
MAX_FOIL_ROUTE_PROMPT_CHARS = 12_000
MAX_ROUTE_CAPSULE_CHARS = 2_048
MAX_STATUS_CAPSULE_CHARS = 4_096
MAX_LEAN_PREFETCH_OUTPUT_BYTES = 196_608
...
WORKER_MAIN = HOST_ROOT / "phase7_worker.py"
MODULE_CLI = HOST_ROOT / "module_cli.py"
OBSERVATION_BRIDGE = HOST_ROOT / "observation_bridge.py"
TOKEN_MEASUREMENT_BRIDGE = HOST_ROOT / "token_measurement_bridge.py"
